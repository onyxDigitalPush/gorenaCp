                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="GET" action="AdminEmpresa.php">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6"><input type="text" name="nomdpt" placeholder="<?php echo $dto->__($lng, "Nom del Departament"); ?>" style="width: 100%"></div>
                                                            </div><br>
                                                            <div class="row">
                                                                <div class="col-lg-2"></div>
                                                                <div class="col-lg-2"><label><?php echo $dto->__($lng, "Àmbit"); ?>: </label></div>
                                                                <div class="col-lg-6"><input type="text" name="ambit" placeholder="<?php echo $dto->__($lng, "Nom de l'àmbit"); ?>" style="width: 100%"></div>
                                                            </div><br>
                                                            <br>
                                                    </div>
                                                ...
                                                <div class="modal-content glassmorphism">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form name="noufest" method="GET" action="AdminEmpresa.php">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <label for="dataany"><?php echo $dto->__($lng, "Data"); ?> Puntual: </label> <input type="date" name="dataany" id="dataany" required>
                                                            <br><br>
                                                            O
                                                            <br><br>
                                                            <label for="dia"><?php echo $dto->__($lng, "Dia"); ?>: </label><input type="number" name="dia" id="dia" placeholder="<?php echo $dto->__($lng, "Dia"); ?>" min="1" max="31" required>
                                                            <label for="mes"><?php echo $dto->__($lng, "Mes"); ?>: </label> <input type="number" name="mes" id="mes" placeholder="<?php echo $dto->__($lng, "Mes"); ?>" min="1" max="12" required>
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-success" data-dismiss="modal" onclick="afegeixFestiuUbicacio(noufest.idubicacio.value,noufest.dia.value,noufest.mes.value,noufest.dataany.value,noufest.nomfestiu.value);"><span class="glyphicon glyphicon-plus"></span><?php echo $dto->__($lng, "Afegir"); ?></button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            ?>
                                            <input type='checkbox' id="chk1marcatge" <?php echo $chk1marcatge; ?> style="width: 25px; height: 25px;" onchange='updateAutomarcaje(<?php echo $idempresa; ?>,1);'>
                                        </div>
                                    </div>
