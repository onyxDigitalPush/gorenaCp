...
<html>
    ...
    $horari = $dto->seleccionaTornsPerHorari($idhorari);
    ?>
            ...
            <div class="modal-dialog glassmorphism">
              <div class="modal-content glassmorphism">
                <div class="modal-body">
                    <h3><?php echo $dto->__($lng,"Horario").": ".$dto->mostraNomHorariPerIdhorari($idhorari); ?></h3><br>
                    <table class="table table-hover table-condensed" style="text-align: center">
                        ...
                        <th style="text-align: center;background-color: #f5f5f5; color: black; font-size:medium;"><?php echo $dto->__($lng,"Entrada"); ?></th>
                        <th style="text-align: center;background-color: #f5f5f5; color: black; font-size:medium;"><?php echo $dto->__($lng,"Sortida"); ?></th>
                        <th style="text-align: center;background-color: #f5f5f5; color: black; font-size:medium;"><?php echo $dto->__($lng,"Hores"); ?></th>
                        
                        <th style="text-align: center;background-color: #f5f5f5; color: black; font-size:medium;"><?php echo $dto->__($lng,"Anticipat"); ?></th>
                        <th style="text-align: center;background-color: #f5f5f5; color: black; font-size:medium;"></th>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            {
                                echo '<tr>';
                                echo '<td style="border-radius:10px">'.$dto->__($lng,$dto->mostraNomDia($dia["diasetmana"])).'</td>';
                                if($dia["laborable"]==1){
                                echo '<td style="border-radius: 10px;">'.substr($dia["horaentrada"],0,5).'</td>';
                                echo '<td style="border-radius: 10px;">'.substr($dia["horasortida"],0,5).'</td>';
                                echo '<td style="border-radius: 10px;">'.$dia["horestreball"].'</td>';
                               
                                echo '<td style="border-radius: 10px;">'.$dto->dirsiono($dia["marcabans"]).'</td>';
                                }
                    ...
                    <br><button type="button" class="btn_modal" data-dismiss="modal"><?php echo $dto->__($lng,"Tornar"); ?></button>
                </div>
              </div>
            </div>
            </center>
